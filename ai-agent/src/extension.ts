...
//     <meta http-equiv="Content-Security-Policy" content="default-src 'none'; style-src 'unsafe-inline'; script-src 'nonce-${nonce}'; connect-src ws://127.0.0.1:*;">
//     <style>
...
//         // Splits on fenced code blocks. Everything goes in via textContent, so no
//         // string is ever parsed as HTML.
...
//                     pre.appendChild(makeCopyButton(cleaned));
...
<head>
    ...
    <style>
        ...
        /* Translucent black works on both the blue and the green bubble
